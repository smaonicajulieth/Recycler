...
import co.edu.poli.model.Post;

import co.edu.poli.repository.Post_repository;
...
public class PostController {
	...
	public String insertPost(@RequestBody List<Post> post) {
	...
	public Post selectPost(@PathVariable String id_post) {
	...
	public String updatePost(@PathVariable String id_usuario, @RequestBody Post post) {

		Post usuarioUpdate = post_repository.findById(id_usuario).get();
		usuarioUpdate.setTitulo(post.getTitulo());
		usuarioUpdate.setDescripcion(post.getDescripcion());
		usuarioUpdate.setImagen_path(post.getImagen_path());
	...
	public List<Post> mostrarPost(@PathVariable String categoria) {
